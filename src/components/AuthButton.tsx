    ...
    <>
      ...
      {showLoginModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
          <div className="bg-spotify-darkgray border border-spotify-gray/30 rounded-2xl shadow-2xl max-w-md w-full p-6 animate-scale-in">
            {/* Header */}
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-spotify-lightgray text-sm">Save tracks to your library</p>
              </div>
            </div>
